...
void ZZZKBotAIModule::onFrame()
{
        ...
        for (auto p : players)
        {
            if (p->isEnemy(Broodwar->self()))
            {
                ...
                if (enemyRaceInit == BWAPI::Races::Unknown &&
                    enemyNameUpperCase == "UALBERTABOT")
                {
                    ss.is4PoolBO = false;
                    ss.isSpeedlingBO = true;
                    ss.isHydraRushBO = false;
                    ss.isMutaRushBO = true;
                    ss.isNumSunkensDecidedAfterScoutEnemyRace = true;
                    ss.numSunkens = 5;
                    ss.numSunkensVsProtoss = 5;
                    ss.numSunkensVsTerran = 3;
                    ss.numSunkensVsZerg = 3;
                    break;
                }
                ...
                if (enemyRaceInit == BWAPI::Races::Protoss &&
                    enemyNameUpperCase == "XIMP")
                {
                    ss.isSpeedlingPushDeferred = true;
                    ss.is4PoolBO = false;
                    ss.isSpeedlingBO = true;
                    ss.isHydraRushBO = false;
                    ss.isMutaRushBO = true;
                ...
                // Guessing it is like tscmooz...
                if (enemyRaceInit == BWAPI::Races::Zerg &&
                    enemyNameUpperCase == "CHERRYPI")
                {
                    ss.is4PoolBO = true;
                    ss.isSpeedlingBO = false;
                    ss.isHydraRushBO = false;
                ...
                if (enemyRaceInit == BWAPI::Races::Protoss &&
                    (enemyNameUpperCase == "SKYNET" ||
                     enemyNameUpperCase == "MEGABOT"))
                {
                    ss.is4PoolBO = true;
                    ss.isSpeedlingBO = false;
                    ss.isHydraRushBO = false;
                ...
                if (enemyRaceInit == BWAPI::Races::Zerg &&
                    enemyNameUpperCase == "STEAMHAMMER")
                {
                    ss.is4PoolBO = false;
                    ss.isSpeedlingBO = false;
                    ss.isHydraRushBO = false;
                ...
                if (enemyRaceInit == BWAPI::Races::Zerg &&
                    enemyNameUpperCase == "ARRAKHAMMER")
                {
                    ss.is4PoolBO = false;
                    ss.isSpeedlingBO = false;
                    ss.isHydraRushBO = false;
                ...
                if (enemyRaceInit == BWAPI::Races::Zerg &&
                    enemyNameUpperCase == "JUNO")
                {
                    ss.isEnemyWorkerRusher = true;
                    ss.is4PoolBO = false;
                    ss.isSpeedlingBO = true;
                    ss.isHydraRushBO = false;
                    ss.isMutaRushBO = true;
                ...
                if (enemyRaceInit == BWAPI::Races::Terran &&
                    enemyNameUpperCase == "IRON")
                {
                    ss.is4PoolBO = false;
                    ss.isSpeedlingBO = false;
                    ss.isHydraRushBO = true;
                    ss.isMutaRushBO = true;
                    ss.numSunkens = 1;
                    break;
                }
                ...
                if (enemyRaceInit == BWAPI::Races::Terran &&
                    enemyNameUpperCase == "HANNESBREDBERG")
                {
                    ss.is4PoolBO = false;
                    ss.isSpeedlingBO = true;
                    ss.isHydraRushBO = false;
    ...
    const int transitionOutOf4PoolFrameCountThresh = (ss.isSpeedlingBO || ss.isHydraRushBO || !ss.is4PoolBO /*|| Broodwar->self()->getName().compare(0, 4, "test") = 0*/ || (Broodwar->self()->getName() != "ZZZKBot") || initialCreepLocsMap.val.empty()) ? 0 : (8 * 60 * 24);
