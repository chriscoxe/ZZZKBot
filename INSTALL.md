...
1. Optionally, if you want to configure how the bot plays against particular opponents, you can place a configuration file at the following location:

   \<Starcraft folder\>/bwapi-data/AI/\<MyInGamePlayerName\>.cfg

   A sample configuration file that illustrates the syntax is in this repository at [MyInGamePlayerName.cfg](ZZZKBot/Configs/bwapi-data/AI/MyInGamePlayerName.cfg).
